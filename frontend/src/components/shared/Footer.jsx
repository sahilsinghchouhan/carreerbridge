      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="text-center md:text-left mb-6 md:mb-0">
            <h2 className="text-2xl font-bold text-blue-600">Career Bridge</h2>
            <p className="text-sm text-gray-600">© 2024 Career Bridge. All rights reserved.</p>
          </div>

          {/* Social Icons */}
          <div className="flex space-x-5">
            <a href="https://facebook.com" className="text-gray-600 hover:text-blue-600 transition" aria-label="Facebook">
            ...
            <a href="https://twitter.com" className="text-gray-600 hover:text-blue-600 transition" aria-label="Twitter">
            ...
            <a href="https://linkedin.com" className="text-gray-600 hover:text-blue-600 transition" aria-label="LinkedIn">
